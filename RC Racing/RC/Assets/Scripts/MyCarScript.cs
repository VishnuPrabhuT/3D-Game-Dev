...
public class MyCarScript : MonoBehaviour {
    ...
    void Move_Car()
    { RR.motorTorque = 5000 * Input.GetAxis("Vertical");
        LR.motorTorque = 5000 * Input.GetAxis("Vertical");
        LF.steerAngle = 20 * Input.GetAxis("Horizontal");
        RF.steerAngle = -20 * Input.GetAxis("Horizontal");
    }
